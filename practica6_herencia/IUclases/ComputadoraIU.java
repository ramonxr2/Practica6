...
import practica6_herencia.Computadora;

public class ComputadoraIU extends Canvas{
    ...
    public ComputadoraIU(String filePath, Computadora computadora) {
    ...
    public void imprimirDevice(Canvas canvas) {
        this.canvas=canvas;
        MiMouseAdapter mouse=new MiMouseAdapter(canvas, computadora,height,width,xPos,yPos);
